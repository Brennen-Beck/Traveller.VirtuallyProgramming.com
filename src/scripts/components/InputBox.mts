class TravellerTextField extends HTMLElement {
    private InternalLabelDiv: HTMLElement;
    private InternalTextContent: HTMLElement;
    ...
    constructor() {
        ...
        TextBoxDiv.style.cssText = 'width: 100%; height: 26px; padding: 4px; background: #FFFEEB; border-radius: 5px; border: 1px #EDE781 solid; justify-content: flex-start; align-items: center; gap: 4px; display: flex;';
        TextBoxField.style.cssText = 'height: 19px; justify-content: center; align-items: center; gap: 10px; display: flex;';
        TextBoxText.style.cssText = 'flex: 1 1 0; height: 19px; color: #7C4C00; font-size: 16px; font-family: Roboto; font-weight: 500; word-wrap: break-word;';
